...
export function compareRank(a: Rankable, b: Rankable) {
  return (
    b.points - a.points ||
    b.exact - a.exact ||
    (b.correctOutcome ?? 0) - (a.correctOutcome ?? 0) ||
    (b.globalPoints ?? 0) - (a.globalPoints ?? 0) ||
    (a.earliestPredictionAt ?? Number.MAX_SAFE_INTEGER) -
      (b.earliestPredictionAt ?? Number.MAX_SAFE_INTEGER) ||
