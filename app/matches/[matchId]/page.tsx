...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `/matches/${encodeURIComponent(match.providerMatchId)}`,
    },
    openGraph: {
      title,
      description: `Make your football prediction for ${title} on LowBlock.`,
      type: "website",
    },
  };
}
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-6 rounded-2xl border border-white/[.08] bg-white/[.03] p-5 text-sm leading-7 text-[var(--muted)]">
          ...
          <p className="mt-2">
            ...
            LowBlock. Open the prediction drawer to choose a score before
            kick-off, or view community analysis after the match starts.
          </p>
        </section>
      </div>
      <script
