          ...
          <div className="relative flex items-start gap-4">
            ...
            <div>
              <p className="text-xs font-black tracking-[.16em] text-brand">
                <T
                  fa="Ù„ÛŒÚ¯â€ŒÙ‡Ø§ Ùˆ ØªÙˆØ±Ù†Ù…Ù†Øªâ€ŒÙ‡Ø§"
                  en="LEAGUES & TOURNAMENTS"
                />
              </p>
              <h1 className="mt-2 text-3xl font-black md:text-5xl">
                <T fa="Ù‡Ù…Ù‡ Ø±Ù‚Ø§Ø¨Øªâ€ŒÙ‡Ø§" en="All competitions" />
              </h1>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-white/60">
                <T
                  fa="Ø±Ù‚Ø§Ø§Ø¨Øª Ù…ÙˆØ±Ø¯ Ù†Ø¸Ø± Ø±Ø§ Ø§Ù†ØªØ®Ø§Ø¨ Ú©Ù†ÛŒØ¯ Ùˆ Ù…Ø³ØªÙ‚ÛŒÙ… Ø¨Ù‡ ØµÙØ­Ù‡ Ø¢Ù† Ø¨Ø±ÙˆÛŒØ¯."
                  en="Choose a competition and jump straight to its fixtures, rounds and leaderboard."
                />
              </p>
            </div>
          </div>
        ...
        <section className="mt-8">
          <div className="mb-4 flex items-end justify-between">
            <h2 className="text-xl font-black md:text-2xl">
              <T fa="Ù‡Ù…Ù‡ Ù„ÛŒÚ¯â€ŒÙ‡Ø§" en="Browse competitions" />
            </h2>
