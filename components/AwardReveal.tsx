...
export function AwardReveal() {
  ...
  async function share() { setBusy(true); setShareError(false); try { await shareAward(award.id); } catch { setShareError(true); } finally { setBusy(false); } }
