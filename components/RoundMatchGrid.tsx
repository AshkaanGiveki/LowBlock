  ...
  return <>
    <section className="mt-7">
      ...
      <div className="grid gap-3 sm:grid-cols-2">{fixtures.map((fixture) => {
        ...
        return <button key={fixture.providerMatchId} onClick={() => { openMatchRoute(fixture.providerMatchId, window.location.pathname); setSelected(fixture.providerMatchId); }} className="group relative overflow-hidden rounded-[1.35rem] border border-white/[.08] bg-[linear-gradient(145deg,#14221a,#0d120f)] p-4 text-start transition hover:-translate-y-1 hover:border-brand/50 hover:shadow-[0_18px_45px_rgba(32,184,121,.14)]">
